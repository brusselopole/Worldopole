		...
		<footer>
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<h3><?= $locales->FOOTER_ABOUT->$lang ?></h3>
					</div>
					<div class="col-md-4">
						<h3>Sources</h3>
						<p><?= $locales->FOOTER_VISUAL_CONTENT->$lang ?></p>
					</div>
					<div class="col-md-4">
						<h3>Pokémon™</h3>
						<p><?= $locales->FOOTER_POKEMON_CONTENT->$lang ?></p>					
					</div>
					<div class="row">
						<div class="col-md-12">
							<p class="text-center"><?= $locales->FOOTER_DATA->$lang ?></p>
						</div>
					</div>
				</div>
			</div>
